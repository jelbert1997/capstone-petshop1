...
<body>
      ...
      <nav class="navbar navbar-inverse" role="banner">
            <div class="container">
                ...
                <!--      <img src="images/logo.jpg"  width="15% "/> --> PetMalu</h4></a>
                </div>
        ...
        <div class="col-md-3" >
            ...
            <div class="panel panel-default wow fadeInDown">
              ...
              <ul class="list-group">
                ...
                <li class="list-group-item wow fadeInDown">boarding <span style="color:#8B8B00; font-weight:bold;">Php 500 to 600 </span> <span style="color:#EE5C42;" class="glyphicon glyphicon-ok pull-right"></span></li>
                 <li class="list-group-item wow fadeInDown">Grooming <span style="color:#8B8B00; font-weight:bold;">Php 150 to 300 </span> <span style="color:#EE5C42;" class="glyphicon glyphicon-ok pull-right"></span></li>
                  <li class="list-group-item wow fadeInDown">training<span style="color:#8B8B00; font-weight:bold;">Php 300 to 450 </span> <span style="color:#EE5C42;" class="glyphicon glyphicon-ok pull-right"></span></li>
                  
                   <li class="list-group-item wow fadeInDown">sitting<span style="color:#8B8B00; font-weight:bold;">Php 200 to 350 </span> <span style="color:#EE5C42;" class="glyphicon glyphicon-ok pull-right"></span></li>
                 -->
